...
public class ScoreB implements Listener {
	public static void setScoreBoard(final Player p) {
		...
		o.setDisplayName(new StringBuilder().append(PublicPvP.getPlugin().getConfig().getString("server").replace("&", "�"))
				.toString());
		...
		final Score killsr = o.getScore(Bukkit.getOfflinePlayer(
				"�a" + PublicPvP.getPlugin().getConfig().getInt("status." + p.getName().toLowerCase() + ".kills")));
		final Score deaths = o.getScore(Bukkit.getOfflinePlayer("�7Morreu�6>>"));
		final Score deathsr = o.getScore(Bukkit.getOfflinePlayer(
				"�c" + PublicPvP.getPlugin().getConfig().getInt("status." + p.getName().toLowerCase() + ".mortes")));
		final Score nick = o.getScore(Bukkit.getOfflinePlayer("�4"));
		final Score espaco4 = o.getScore(Bukkit.getOfflinePlayer("�7Level�6>>"));
		final Score nickr = o.getScore(Bukkit.getOfflinePlayer("�a" + PublicPvP.cash.get(p)));
		final Score deathsr2 = o.getScore(Bukkit.getOfflinePlayer("�7Coins�6>>"));
		final Score espaco5 = o.getScore(Bukkit.getOfflinePlayer("�a" + PublicPvP.econ.getBalance((OfflinePlayer) p)));
		espaco3.setScore(13);
		kills.setScore(12);
		killsr.setScore(11);
		deaths.setScore(10);
