        ...
        if (cmd.getName().equalsIgnoreCase("tag")) {
            if (args.length > 0 && p.hasPermission("tag.dono")) {
                if (args[0].toLowerCase().equalsIgnoreCase("normal")) {
                    ...
                    p.setPlayerListName(ChatColor.GOLD + ChatColor.ITALIC.toString() + getShortStr(ChatColor.stripColor(p.getDisplayName())));
                    p.setDisplayName(ChatColor.GOLD + ChatColor.ITALIC.toString() + ChatColor.stripColor(p.getDisplayName()) + ChatColor.RESET);
                }
                    ...
                    p.setPlayerListName(String.valueOf(Tag.mod) + ChatColor.ITALIC.toString() + getShortStr(ChatColor.stripColor(p.getDisplayName())));
                    ...
                    p.setPlayerListName(ChatColor.RED + ChatColor.ITALIC.toString() + getShortStr(ChatColor.stripColor(p.getDisplayName())));
                    p.setDisplayName(ChatColor.RED + ChatColor.ITALIC.toString() + ChatColor.stripColor(p.getDisplayName()) + ChatColor.RESET);
                }
                    ...
                    p.sendMessage(String.valueOf(Tag.admin) + "Use: (Normal | Pro | Lifetime | Youtuber | Mod | ModPlus | Admin | AdminPlus | Dono)");
                }
            }
                ...
                if (args[0].toLowerCase().equalsIgnoreCase("normal")) {
                    ...
                    p.sendMessage(String.valueOf(Tag.admin) + "Use: (Normal | Pro | Lifetime | Youtuber | Mod | ModPlus | Admin)");
                }
            }
                ...
                if (args[0].toLowerCase().equalsIgnoreCase("normal")) {
                    ...
                    p.sendMessage(String.valueOf(Tag.admin) + "Use: (Normal | Pro | Lifetime | Youtuber | Mod | ModPlus | Admin | AdminPlus)");
                }
            }
                ...
                if (args[0].toLowerCase().equalsIgnoreCase("normal")) {
                    ...
                    p.sendMessage(Tag.msg.replace("%s", "§5MOD"));
                    p.setPlayerListName(String.valueOf(Tag.mod) + getShortStr(ChatColor.stripColor(p.getDisplayName())));
                    p.setDisplayName(String.valueOf(Tag.mod.toString()) + ChatColor.stripColor(p.getDisplayName()) + ChatColor.RESET);
                }
                else {
                ...
                if (args[0].toLowerCase().equalsIgnoreCase("normal")) {
                    ...
                    p.sendMessage(String.valueOf(Tag.admin) + "Use: (Normal | Pro | Lifetime | Youtuber | Trial | Mod | ModPlus)");
                }
            }
                ...
                p.sendMessage(String.valueOf(Tag.admin) + "Use: (Normal | Pro | Lifetime | Youtuber | Trial | Mod | ModPlus | Admin | AdminPlus | Dono)");
            }
            else if (p.hasPermission("tag.adminplus")) {
                p.sendMessage(String.valueOf(Tag.admin) + "Use: (Normal | Pro | Lifetime | Youtuber | Trial | Mod | ModPlus | Admin | AdminPlus)");
            }
            else if (p.hasPermission("tag.admin")) {
                p.sendMessage(String.valueOf(Tag.admin) + "Use: (Normal | Pro | Lifetime | Youtuber | Trial | Mod | ModPlus | Admin)");
            }
