...
public class Utils implements Listener
{
    ...
    public void antiPluginView(final PlayerCommandPreprocessEvent evento) {
        ...
        if (evento.getMessage().equalsIgnoreCase("/pl") || evento.getMessage().equalsIgnoreCase("/plugins") || evento.getMessage().equalsIgnoreCase("/plugin") || evento.getMessage().equalsIgnoreCase("/help") || evento.getMessage().equalsIgnoreCase("/bukkit") || evento.getMessage().equalsIgnoreCase("/?")) {
    ...
    public static void onDia() {
        Main.getPlugin().getServer().getScheduler().scheduleSyncRepeatingTask(Main.getPlugin(), (Runnable)new Runnable() {
            @Override
            public void run() {
    ...
    public void onEntityDamageByEntity1(final EntityDamageByEntityEvent e) {
        if (e.getDamager() instanceof Player) {
            ...
            if (d.getItemInHand().getType() == Material.DIAMOND_SWORD || d.getItemInHand().getType() == Material.WOOD_SWORD || d.getItemInHand().getType() == Material.STONE_SWORD || d.getItemInHand().getType() == Material.IRON_SWORD || d.getItemInHand().getType() == Material.WOOD_AXE) {
    ...
    public void onPlayer(final PlayerMoveEvent e) {
        final Player p = e.getPlayer();
        if (!this.mecheu.contains(p.getName()) && e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.JUKEBOX) {
            ...
            p.sendMessage(" §l§6>> §eParabens Voc\u00ea Concluiu o N\u00edvel Facil do LavaChallenger e Por isso Recebeu §6100 §eCOINS !");
            p.teleport(p.getWorld().getSpawnLocation());
    ...
    public void onPlayer1(final PlayerMoveEvent e) {
        final Player p = e.getPlayer();
        if (!this.mecheu.contains(p.getName()) && e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.LAPIS_BLOCK) {
            final ItemStack cute1 = new ItemStack(Material.CHEST);
            final ItemStack cute2 = new ItemStack(Material.DIAMOND);
            final ItemStack cute3 = new ItemStack(Material.IRON_INGOT);
            p.getInventory().clear();
            ...
            p.setGameMode(GameMode.ADVENTURE);
            Main.econ.depositPlayer(p.getName(), 100.0);
            p.sendMessage(" §l§6>> §eParabens Voc\u00ea Concluiu o N\u00edvel Medio do LavaChallenger e Por isso Recebeu §6150 §eCOINS !");
        }
    }
    ...
    public void onPlayer11(final PlayerMoveEvent e) {
        ...
        if (!this.mecheu.contains(p.getName()) && e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.COAL_BLOCK) {
            ...
            p.sendMessage(" §l§6>> §eParabens Voc\u00ea Concluiu o N\u00edvel Dif\u00edcil do LavaChallenger e Por isso Recebeu §6200 §eCOINS !");
        }
    }
    ...
    public void onPlayer111(final PlayerMoveEvent e) {
        final Player p = e.getPlayer();
        if (!this.mecheu.contains(p.getName()) && e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.QUARTZ_BLOCK) {
            final ItemStack cute1 = new ItemStack(Material.CHEST);
            final ItemStack cute2 = new ItemStack(Material.DIAMOND);
            final ItemStack cute3 = new ItemStack(Material.IRON_INGOT);
            p.getInventory().clear();
            ...
            p.sendMessage(" §l§6>> §eParabens Voc\u00ea Concluiu o N\u00edvel Extreme do LavaChallenger e Por isso Recebeu §6300 §eCOINS + Kit ->");
    ...
    public void onPlayer1111(final PlayerMoveEvent e) {
        final Player p = e.getPlayer();
        if (!this.mecheu.contains(p.getName()) && e.getTo().getBlock().getRelative(BlockFace.DOWN).getType() == Material.DIAMOND_BLOCK) {
    ...
    public void onInteractpyro(final PlayerInteractEvent event) {
        ...
        if (event.getAction() == Action.RIGHT_CLICK_AIR && item != null && item.getType() == Material.FIREBALL) {
            ...
            final Fireball ball = (Fireball)event.getPlayer().launchProjectile((Class)Fireball.class);
    ...
    public void onInteractpyro1(final PlayerInteractEvent event) {
        ...
        if (event.getAction() == Action.LEFT_CLICK_AIR && item != null && item.getType() == Material.FIREBALL) {
            ...
            final Snowball ball = (Snowball)event.getPlayer().launchProjectile((Class)Snowball.class);
