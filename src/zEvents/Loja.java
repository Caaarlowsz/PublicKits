...
public class Loja implements CommandExecutor, Listener
{
    ...
    public void InventoryClickEvent(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equals("§e§nLoja de Kits") && e.getCurrentItem() != null && e.getCurrentItem().getItemMeta() != null && e.getCurrentItem().getItemMeta().hasDisplayName()) {
            e.setCancelled(true);
            if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§eViking")) {
                if (!Main.perm.has(pi, "kitxc.viking")) {
                    if (Main.econ.has(pi.getName(), 10000.0)) {
                        ...
                        pi.sendMessage(String.valueOf(Main.getPlugin().getConfig().getString("server").replace("&", "§")) + ">> §6Voc\u00ea comprou o kit viking");
                        pi.closeInventory();
                    }
                    else {
                        pi.closeInventory();
                        pi.sendMessage(String.valueOf(Main.getPlugin().getConfig().getString("server").replace("&", "§")) + ">> §cVoc\u00ea n\u00e3o tem Coins suficiente");
                    }
                }
                else {
                ...
                if (!Main.perm.has(pi, "kitxc.terrorista")) {
                    if (Main.econ.has(pi.getName(), 10000.0)) {
                        ...
                        pi.sendMessage(String.valueOf(Main.getPlugin().getConfig().getString("server").replace("&", "§")) + ">> §6Voc\u00ea comprou o kit IronMan");
                        pi.closeInventory();
                    }
                    else {
                        pi.closeInventory();
                ...
                if (!Main.perm.has(pi, "kitxc.deshfire")) {
                    if (Main.econ.has(pi.getName(), 10000.0)) {
                        ...
                        pi.sendMessage(String.valueOf(Main.getPlugin().getConfig().getString("server").replace("&", "§")) + ">> §6Voc\u00ea comprou o kit DeshFire");
                        pi.closeInventory();
                    }
                    else {
                        pi.closeInventory();
        ...
        if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§eSonic")) {
            if (!Main.perm.has(pi, "kitxc.sonic")) {
                if (Main.econ.has(pi.getName(), 10000.0)) {
                    ...
                    pi.sendMessage(String.valueOf(Main.getPlugin().getConfig().getString("server").replace("&", "§")) + ">> §6Voc\u00ea comprou o kit sonic");
                    pi.closeInventory();
                }
                else {
                    pi.closeInventory();
        ...
        if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§eNinja")) {
            if (!Main.perm.has(pi, "kitxc.ninja")) {
                if (Main.econ.has(pi.getName(), 10000.0)) {
                    ...
                    pi.sendMessage(String.valueOf(Main.getPlugin().getConfig().getString("server").replace("&", "§")) + ">> §6Voc\u00ea comprou o kit ninja");
                    pi.closeInventory();
                }
                else {
                    pi.closeInventory();
        ...
        if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§eWoodMan")) {
            if (!Main.perm.has(pi, "kitxc.woodman")) {
                if (Main.econ.has(pi.getName(), 10000.0)) {
                    Main.econ.withdrawPlayer(pi.getName(), 10000.0);
                    Main.perm.playerAdd(pi, "kitxc.sonic");
                    pi.sendMessage(String.valueOf(Main.getPlugin().getConfig().getString("server").replace("&", "§")) + ">> §6Voc\u00ea comprou o kit woodman");
                    pi.closeInventory();
                }
                else {
                    pi.closeInventory();
    ...
    public static void guiMake(final Player p) {
        ...
        final List loresniper = new ArrayList();
        ...
        final List flashlore = new ArrayList();
        ...
        final List fujaolore = new ArrayList();
        ...
        final List fujaolore2 = new ArrayList();
