...
public class Kangaroo implements CommandExecutor, Listener
{
    ...
    public void onTomarDano(final EntityDamageEvent event) {
        ...
        if (e instanceof Player) {
            ...
            if (event.getEntity() instanceof Player && event.getCause() == EntityDamageEvent.DamageCause.FALL && player.getInventory().contains(Material.FIREWORK) && event.getDamage() >= 2.0) {
                event.setDamage(2.0);
            }
        }
    }
