...
public class Sonic implements Listener, CommandExecutor
{
    ...
    public void interact(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && Arrays.shadow.contains(p.getName()) && p.getItemInHand().getType() == Material.LAPIS_BLOCK) {
            e.setCancelled(true);
            p.updateInventory();
            ...
            p.sendMessage(String.valueOf(Main.getPlugin().getConfig().getString("server").replace("&", "§")) + " >>  §eSonic Usado!");
