...
public class Velotrol implements CommandExecutor, Listener
{
    ...
    public void InteractVelotrol(final PlayerInteractEvent e) {
        ...
        if (p.getItemInHand().equals((Object)Velotrol)) {
            ...
            VelotrolItem.setMetadata("Velotrol", (MetadataValue)new FixedMetadataValue(Main.getPlugin(), (Object)p.getName()));
            ...
            Bukkit.getServer().getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), (Runnable)new Runnable() {
                ...
                public void run() {
                    ...
                    final Location Localiza\u00e7\u00e3o = new Location(p.getWorld(), Velotrol.this.Bloco.get(p.getName()).getX(), Velotrol.this.Bloco.get(p.getName()).getY() + 1.0, Velotrol.this.Bloco.get(p.getName()).getZ());
                    final Location Localiza\u00e7\u00e3oz = new Location(p.getWorld(), Velotrol.this.Bloco.get(p.getName()).getX(), Velotrol.this.Bloco.get(p.getName()).getY() + 2.0, Velotrol.this.Bloco.get(p.getName()).getZ());
